...
import { createCredential, deleteUserCredential, findAllCredentials, findCredential } from "../Controllers/credentialsController.js";
...
credentialsRouter.get("/find/credential/:id", validateToken, findCredential);
